...
class CourierSearchPage extends StatelessWidget {
  ...
  Widget _round(double s, IconData i, VoidCallback f) => InkWell(
        onTap: f,
        ...
        child: Container(
          ...
          child: Icon(i, color: const Color(0xFF173C84), size: 25 * s),
        ),
      );

  Widget _feature(double s, IconData i, String t) => Row(
        ...
        children: [
          Container(
            ...
            child: Icon(i, color: blue, size: 20 * s),
          ),
          SizedBox(width: 7 * s),
          Text(t, style: TextStyle(fontSize: 10.5 * s, height: 1.2, color: const Color(0xFF40506A), fontWeight: FontWeight.w700)),
        ],
      );
      ...
      child: Stack(children: [
                ...
                Marker(
                  ...
                  child: Container(
                    ...
                    child: Container(
                      ...
                      child: Icon(Icons.location_on_rounded, color: Colors.white, size: 28 * s),
                    ),
                  ),
                ),
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Text('© OpenStreetMap katkıda bulunanlar', style: TextStyle(fontSize: 7.5 * s, color: const Color(0xFF59677B))),
          ),
        ),
      ]),
    );
  ...
  Widget _details(double s) => Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [BoxShadow(color: Color(0x0D000000), blurRadius: 18, offset: Offset(0, 5))],
        ),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(color: const Color(0xFFF7FAFD), borderRadius: BorderRadius.circular(16 * s)),
            child: Row(children: [
              Container(
                width: 42 * s,
                height: 42 * s,
                decoration: const BoxDecoration(color: Color(0xFFEAF4FF), shape: BoxShape.circle),
                child: Icon(Icons.inventory_2_rounded, color: blue, size: 22 * s),
              ),
              SizedBox(width: 10 * s),
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                Text('Tahmini Ücret', style: TextStyle(fontSize: 9.5 * s, color: muted)),
  ...
  Widget _addressRow(double s, Color color, String title, String sub, String km) => Row(children: [
        Container(
          width: 32 * s,
          height: 32 * s,
          decoration: BoxDecoration(color: color.withValues(alpha: .12), shape: BoxShape.circle),
          child: Icon(Icons.location_on_rounded, color: color, size: 19 * s),
        ),
        SizedBox(width: 10 * s),
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(title, style: TextStyle(fontSize: 11 * s, color: muted, fontWeight: FontWeight.w600)),
          Text(sub, style: TextStyle(fontSize: 13 * s, color: navy, fontWeight: FontWeight.w800)),
        ])),
        Text(km, style: TextStyle(fontSize: 11 * s, color: navy, fontWeight: FontWeight.w700)),
      ]);

  Widget _action(double s, IconData i, String t, Color bg, Color fg) => Container(
        height: 52 * s,
        decoration: BoxDecoration(color: bg, borderRadius: BorderRadius.circular(18 * s)),
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Icon(i, color: fg, size: 21 * s),
          SizedBox(width: 7 * s),
          Flexible(child: Text(t, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 12 * s, color: fg, fontWeight: FontWeight.w800))),
        ]),
      );
}
