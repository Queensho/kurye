                  ...
                  child: StreamBuilder<List<Map<String, dynamic>>>(
                    ...
                    builder: (context, snapshot) {
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 4 * s),
                                Text(
                                  'Havuzdan aldığın işler burada görünür.',
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (_, i) {
                          final item = rows[i];
                          final code = (item['public_code'] ?? 'Gönderi')
                              .toString();
                          final pickup = (item['pickup_address'] ?? '')
                              .toString();
                          final dropoff = (item['dropoff_address'] ?? '')
                              .toString();
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        '₺${((item['courier_earning'] ?? item['estimated_price'] ?? 0) as num?)?.round() ?? 0}',
                                        style: TextStyle(
                                          color: navy,
                                          fontSize: 14 * s,
                                          fontWeight: FontWeight.w900,
